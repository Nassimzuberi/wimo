...
CREATE TABLE IF NOT EXISTS departement (
  ...
  departement_code varchar(3) SET NAMES 'utf8' DEFAULT NULL,
  departement_nom varchar(255) SET NAMES 'utf8' DEFAULT NULL,
  departement_nom_uppercase varchar(255) SET NAMES 'utf8' DEFAULT NULL,
  departement_slug varchar(255) SET NAMES 'utf8' DEFAULT NULL,
