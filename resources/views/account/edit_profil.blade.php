    ...
    <div class="pt-5">
        ...
        <div class="container p-5 align-items-center text-center ">
            ...
            <form method="post" action="{{route('comptes.update',Auth::user())}}" enctype="multipart/form-data">
                ...
                @method('PUT')
                <div class="my-2">
                    <img src="{{asset(file_exists(public_path().'/images/user-icons/'.Auth::id().'.jpg') ? '/images/user-icons/'.Auth::id().'.jpg' : '/images/user-icon.png')}}" alt="user-img" class="rounded" width="20%">
                </div>
