...
@section('content')
    ...
    <div class="text-center" style="margin:15px;background-color:#ffffff;">
        ...
        <div>
            <img class="rounded-circle" style="margin-top:-70px;" src="{{Storage::url(Auth::user()->avatar)}}" height="150px" width="150px" />
            ...
            <p>
                <small style="padding:20px;padding-bottom:0;padding-top:5px;">Statut :
                    ...
                    @elseif(isset($seller_id)) <span>@lang('app.seller')</span>
